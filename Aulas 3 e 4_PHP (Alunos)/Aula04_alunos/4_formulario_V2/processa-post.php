...
<body>
    ...
    <?php  
        // SE + OU (|| (Quando o usuário não preencher nome e-mail))
    ...
    <?php 
        ...
        // Operadores de coalescência nula (Verifica se o que está a esquerda existe (intereses), senão pega o da direita, neste caso vazio [])
        $interesses = filter_var_array($_POST ['interesses'] ?? [], FILTER_SANITIZE_FULL_SPECIAL_CHARS);

        $escolha = filter_input(INPUT_POST, 'escolha', FILTER_SANITIZE_FULL_SPECIAL_CHARS);
