    ...
    <div class="row">
        ...
        <div class="col">
            ...
            <?php
                    ...
                    echo "<br>Porque " . '$a' ." vale $a <br>";
                    echo 'e $b vale' . "$b" . '<br>'; 
                    echo 'Primeira conta (soma do primeiro parentese): ' . "$a" . ' (que é o valor de $a) + 3 == 8<br>';
                    echo 'Segunda conta (multiplicação do segundo parentese): 5 x ' . "$b" . ' (que é o valor do $b) == 20<br>';
                    echo "Terceira conta (multiplicações de fora do parentese): 8 x 4 == 32 <br>";
                    echo "Quarta conta (soma de fora do parentese): 32 + 20 é 52 <br>";
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            // Comando echo para exibir valor 
                            echo "Novo valor: " . number_format($a **= $b,2,",","."); 
                            ?>
                        </td>
                        <td>$a recebe 10 e $b recebe 5</td>
                    </tr>
